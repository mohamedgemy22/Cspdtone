...
public class ItemAdapter extends RecyclerView.Adapter<ItemAdapter.ItemViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ItemViewHolder holder, int position) {
        ...
        holder.mSatScore.setText(university.getSat_score_range_min() + " - " + university.getSat_score_range_max());
        holder.mActRange.setText(university.getEst_score_range_max() + " - " + university.getEst_score_range_max());
